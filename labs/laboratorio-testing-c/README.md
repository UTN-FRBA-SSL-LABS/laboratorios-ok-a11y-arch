...
> R:lo que hace es inicializar en 0 ya que si no hace eso puede contener datos basura de antes.
...
> R:el error esta en la linea 34 y dice: (BUG: falta multiplicar por cantidad)
